# Adapted from https://github.com/smartdesignworldwide/Technology-Blog-Post-Supplementary-Material/blob/main/mp_rs_code_sample.py
...
while True:
    ...
    if results.multi_hand_landmarks:
        ...
        for handLms in results.multi_hand_landmarks:
            ...
            images = cv2.putText(
                images,
                f"{hand_side} Hand Distance: {mfk_distance_feet:0.3} feet ({mfk_distance:0.3} m) away",
                org2,
                font,
                fontScale,
                color,
        ...
        images = cv2.putText(
            images, "No Hands", org, font, fontScale, color, thickness, cv2.LINE_AA
        )
